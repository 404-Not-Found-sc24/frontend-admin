...
const ViewEvent: React.FC = () => {
  const [rowsNoticeData, setRowsNoticeData] = useState<NoticeDetail | null>(
    null,
  );
  ...
  const getNoticeData = async () => {
    try {
      ...
      const response = await axios.get(`/event/event/${noticeData.eventId}`, {
        headers: {
